    ...
    ?>
        ...
        <div class="container">
            <form action="?do=insert" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input name="email" type="email" class="form-control" id="formGroupExampleInput3" autocomplete="off" placeholder="E-mail"  required>
                </div>
                <div class="form-group">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ((checkIfExists("username", "users", $username)) === 0) {
                ...
                echo '<a class="btn btn-primary text-center" href="index.php">RETOUR</a>';
                echo '</div>';
            } else {
