    ...
    ?>
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ((checkIfExists("username", "users", $username)) === 0) {
                ...
                echo '<a class="btn btn-primary text-center" href="http://localhost/Brief9/admin/members.php">RETOUR</a>';
                echo '</div>';
            } else {
...
<?php
        ...
        if ($countID > 0) {
            ...
            echo '<div class="container text-center">';
            echo '<a class="btn btn-primary" href="http://localhost/Brief9/admin/members.php">RETOUR</a>';
            echo '</div>';
        } else {
